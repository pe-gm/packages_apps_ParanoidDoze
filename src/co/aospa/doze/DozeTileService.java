...
public class DozeTileService extends TileService {
    ...
    public void onClick() {
        super.onClick();
        Intent ParanoidDoze = new Intent(this, DozeSettingsActivity.class);
        ParanoidDoze.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivityAndCollapse(ParanoidDoze);
    }
}
